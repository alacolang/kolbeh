export const childData = [
  {
    name: "kid",
    title: "اتاق کودک",
    description: ` به اتاق کودک کلبه خوش آمدی. مطالب این اتاق به تو کمک می‌کنه که احساساتت رو بهتر بشناسی و حالت خوب باشه، همین‌طور فکرهات، رفتارت، اینکه چطور با همسالانت دوست بشی، دوست بمونی، چطوری نذاری قلدرها بهت زور بگن، چطور با دوستانت یک گروه بشین و به هم کمک کنین.`,
    feed: [
  ...
  },
  {
    name: "teen",
    title: "اتاق نوجوان",
    description: ` به اتاق نوجوان کلبه خوش‌ آمدی. مطالب این اتاق کمک می‌کنه که با احساساتتون بیشتر آشنا بشین و برای دغدغه‌ها و نگرانی‌هایی که دارین پاسخ‌هایی بگیرین که یک مشاور پیشنهاد می¬کنه.`,
    feed: [
