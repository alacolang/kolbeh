export const childData = [
  {
    name: "kid",
    title: "اتاق کودک",
    description: `به اتاق کودک کلبه خوش آمدی. مطالب این اتاق به تو کمک می‌کنه که احساساتت رو بهتر بشناسی و حالت خوب باشه، همین‌طور فکرهات، رفتارت، اینکه چطور با همسالانت دوست بشی، دوست بمونی، چطوری نذاری قلدرها بهت زور بگن، چطور با دوستانت یک گروه بشید و به هم کمک کنید.`,
    feed: [
